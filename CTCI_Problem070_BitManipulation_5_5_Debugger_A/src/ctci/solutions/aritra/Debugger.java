 ...
 *    -     1 
 *    =593099
 * When you subtract 1 from a number, you look at the least significant bit. If it's a 1 you change it to 0, and you are done. If it's a
 * zero, you must borrow from a larger bit. So, you go to increasingly larger bits, changing each bit from a 0 to a 1, until you find a
 * 1. You flip that 1 to a 0 and you are done.
 * 
 ...
 * if n = abcde1000
 * then n - 1 = abcde0111
 * abcde must all be 0s, which means that n must look like this: 00001000. The value of n is therefore a power of two
